		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PcDiNiS Web Center",
									"targetURL": "#ptpcdinisui5webcenterwebcenter-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ptpcdinisui5webcenterwebcenter-display": {
								"semanticObject": "ptpcdinisui5webcenterwebcenter",
								"action": "display",
								"description": "The place for annoying apps!!!",
								"title": "PcDiNiS Web Center",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pt.pcdinis.ui5webcenter.webcenter",
									"url": sap.ui.require.toUrl("pt/pcdinis/ui5webcenter/webcenter")
								}
							}
						}
					}
